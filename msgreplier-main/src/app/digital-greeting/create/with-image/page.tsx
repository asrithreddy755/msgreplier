...
import TemplateCake from "../../components/with-image/TemplateCake";
import TemplateAurora from "../../components/with-image/TemplateAurora";
import TemplateClassic2D from "../../components/with-image/TemplateClassic2D";
  ...
  return (
    <div className="create-page">
          ...
          <>
            ...
            {formData.theme !== "propose_crush1" && formData.theme !== "wishes6" && formData.theme !== "wishes7" && formData.theme !== "wishes9" && formData.theme !== "apology_1" && formData.theme !== "wishes11" && formData.theme !== "wishes12" && formData.theme !== "wishes13" && formData.theme !== "wishes15" && formData.theme !== "wishes16" && (
              <div className="create-field">
                ...
                {user ? (
                  formData.theme === "hearts" || formData.theme === "classic-2d" || formData.theme === "aurora" || formData.theme === "wishes5" || formData.theme === "wishes3" || formData.theme === "wishes6" || formData.theme === "wishes7" || formData.theme === "wishes8" || formData.theme === "wishes10" ? (
                    /* Render multiple slots for Cake Surprise, Classic 2D, Cham 3D, Zodiac or Retro templates */
                          ...
                          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                            {photo.url ? (
                              <div style={{ width: '80px', height: '80px', borderRadius: '12px', overflow: 'hidden', border: '1px solid #fecdd3', flexShrink: 0 }}>
                                <img src={photo.url} alt={`Slot ${index + 1}`} style={{ width: '100%', height: '100%', objectFit: photoFitMode ? 'cover' : 'contain' }} />
                              </div>
                            ) : (
                              <button
                                type="button"
                    ...
                    <div className="create-photo-box">
                      {formData.photo_url ? (
                        <div className="create-photo-preview">
                          <img src={formData.photo_url} alt="Preview" style={{ objectFit: photoFitMode ? 'cover' : 'contain' }} />
                          <button
                            type="button"
            ...
            {(formData.theme === "hearts" || formData.theme === "classic-2d" || formData.theme === "aurora" ||
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                  <span style={{ fontSize: '12px', fontWeight: 700, color: '#be123c' }}>Fit to frame</span>
                  <span style={{ fontSize: '11px', color: '#9e8a8e' }}>
                    {photoFitMode ? 'Photos cropped to fill the template frame' : 'Full photo visible (may have letterbox bars)'}
                  </span>
                </div>
                <button
                  type="button"
                  onClick={() => setPhotoFitMode(m => !m)}
                  aria-pressed={photoFitMode}
                  title="Toggle photo fit mode"
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: '6px',
                ...
                >
                  ...
                  <span style={{
                    ...
                    height: '24px',
                    borderRadius: '50px',
                    background: photoFitMode ? 'linear-gradient(135deg,#be123c,#e11d48)' : 'rgba(0,0,0,0.12)',
                    position: 'relative',
                    transition: 'background 0.3s',
                    border: photoFitMode ? '1.5px solid #be123c' : '1.5px solid rgba(0,0,0,0.1)',
                    boxShadow: photoFitMode ? '0 0 0 2px rgba(190,18,60,0.15)' : 'none',
                  }}>
                    {/* Thumb */}
                    <span style={{
                      position: 'absolute',
                      top: '3px',
                      left: photoFitMode ? '22px' : '3px',
                      width: '16px',
                      height: '16px',
                      borderRadius: '50%',
                      background: '#fff',
                  ...
                  <span style={{
                    fontSize: '11px',
                    fontWeight: 700,
                    color: photoFitMode ? '#be123c' : '#9e8a8e',
                    minWidth: '22px',
      ...
      <GalleryPickerModal
        ...
        onSelect={(url) => {
          if ((formData.theme === "hearts" || formData.theme === "classic-2d" || formData.theme === "aurora" || formData.theme === "wishes5" || formData.theme === "wishes3" || formData.theme === "wishes6" || formData.theme === "wishes7" || formData.theme === "wishes8" || formData.theme === "wishes10") && activePhotoSlot !== null) {
            const photos = getPhotosArray(formData.photo_url);
            photos[activePhotoSlot].url = url;
            setFormData((prev) => ({ ...prev, photo_url: JSON.stringify(photos) }));
          } else {
            // Single photo (wishes4, wishes3, or any other)
