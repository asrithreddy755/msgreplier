  ...
  return (
    <div className="container max-w-3xl py-12 px-4 md:px-6 mx-auto">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">Our Core Values</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 bg-muted/40 rounded-xl border border-border/50 text-center">
            ...
            <p className="text-sm">Treat every user with kindness and dignity.</p>
          </div>
          <div className="p-4 bg-muted/40 rounded-xl border border-border/50 text-center">
            <div className="text-2xl mb-2">🔒</div>
            <h3 className="font-semibold text-foreground mb-1">Privacy</h3>
            <p className="text-sm">Protect your own and others&apos; personal information.</p>
          </div>
          <div className="p-4 bg-muted/40 rounded-xl border border-border/50 text-center">
            <div className="text-2xl mb-2">✨</div>
            <h3 className="font-semibold text-foreground mb-1">Positivity</h3>
            <p className="text-sm">Keep interactions uplifting, warm, and constructive.</p>
          </div>
        </div>

        <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">What Is Allowed ✅</h2>
        ...
        <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">What Is Not Allowed ❌</h2>
        <ul className="space-y-3">
        ...
        <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">Privacy in Love-Space</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">Wishes Website Content Standards</h2>
        <p>
        ...
        <div className="mt-8 p-5 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-700/50">
          <div className="flex items-start gap-3">
            <AlertTriangle className="h-5 w-5 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
            <div>
              <h3 className="font-semibold text-amber-900 dark:text-amber-200 mb-1">Enforcement</h3>
        ...
        <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">Reporting Abuse</h2>
        <p>
        ...
        <div className="mt-4 flex items-center gap-3 p-4 bg-muted/40 rounded-xl border border-border/50">
        ...
        <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">Changes to These Guidelines</h2>
        <p>
