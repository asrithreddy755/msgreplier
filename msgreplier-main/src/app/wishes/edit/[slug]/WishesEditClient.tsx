  ...
  return (
    <div className="wishes-edit-page">
          ...
          <div className="wishes-field" style={{ marginTop: '1.5rem' }}>
            <label className="wishes-label">
              ...
              <span style={{ fontWeight: 400, color: '#94a3b8', fontSize: '11px', marginLeft: '4px' }}>
                {['wishes3', 'wishes5', 'wishes6', 'wishes7', 'wishes8', 'wishes10'].includes(theme) ? ' (recommended)' : ' (optional)'}
              </span>
            </label>
            {['hearts', 'classic-2d', 'aurora', 'wishes3', 'wishes5', 'wishes6', 'wishes7', 'wishes8', 'wishes10'].includes(theme) ? (
      ...
      <GalleryPickerModal
        ...
        onSelect={(url) => {
          if ((theme === 'hearts' || theme === 'classic-2d' || theme === 'aurora' || theme === 'wishes5' || theme === 'wishes3' || theme === 'wishes6' || theme === 'wishes7' || theme === 'wishes8' || theme === 'wishes10') && activePhotoSlot !== null) {
            const photos = getPhotosArray(photoUrlValue || '');
