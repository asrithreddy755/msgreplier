export type Platform = {
  id: 'instagram' | 'whatsapp' | 'telegram' | 'x' | 'facebook' | 'youtube' | 'custom' | 'ai-reply' | 'shortcutpedia';
  name: string;
  charLimit: number;
  slug: string;
};
...
export const PLATFORMS: Platform[] = [
  { id: 'shortcutpedia', name: 'Shortcutpedia', charLimit: 0, slug: 'shortcutpedia' },
  { id: 'ai-reply', name: 'Msg Prompt', charLimit: 0, slug: 'prompt' },
